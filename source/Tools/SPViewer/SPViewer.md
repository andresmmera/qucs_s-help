...
* [Data display panel](/Tools/SPViewer/Data-display-panel/index)
    - Contains the display widgets for visualizing the data
* [Data management panel](/Tools/SPViewer/Data-management-panel/index)
...
```{figure} /Tools/SPViewer/images/SPViewer-UI-layout-overview.png
---
class: with-border
---
